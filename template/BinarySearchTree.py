...
class BinarySearchTree(BinaryTree, Set):
    ...
    def find_or_successor(self, key: object) -> BinaryTree.Node:
        """
        Returns the node containing the given key if it exists;
