...
tree = BinaryTree()
root = tree.Node('A')
b = root.insert_left(tree.Node('B'))
c = root.insert_right(tree.Node('C'))
d = b.insert_left(tree.Node('D'))
e = b.insert_right(tree.Node('E'))
f = c.insert_left(tree.Node('F'))
g = c.insert_right(tree.Node('G'))
print(tree)
'''